...
export default function Home() {
  return (
    <>
      <section
        className='snap-always snap-start relative flex gap-16 max-xl:gap-8 flex-col w-full min-h-screen px-64 max-xl:px-6 py-32 max-xl:py-16'
        data-bg='light'
      >
        <div className="relative w-full aspect-[21/9] max-xl:aspect-[2/3]">
          <Image
